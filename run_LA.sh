...
trialMetadata=/app/ASVspoof2021_LA_eval/keys/LA/ASV/trial_metadata.txt
...
time CUDA_VISIBLE_DEVICES=0 python main_SSL_LA.py --track=LA --is_eval --eval --model_path=/app/model/LA_model.pth --eval_output=$resultsPath/eval_CM_scores_file_SSL_LA.txt --database_path /app/ --protocols_path shorteval/
echo "python evaluate_2021_LA.py $resultsPath/eval_CM_scores_file_SSL_LA.txt /app/ASVspoof2021_LA_eval/keys/LA/ progress"
python evaluate_2021_LA.py $resultsPath/eval_CM_scores_file_SSL_LA.txt /app/ASVspoof2021_LA_eval/keys/LA/ progress
